...
Requires: varnish >= 9.1.0, hiredis >= 0.11.0, libev >= 4.03
BuildRequires: make, python-docutils, varnish >= 9.1.0, varnish-devel >= 9.1.0, hiredis-devel >= 0.11.0, libev-devel >= 4.03
...
%changelog
* Fri Sep 18 2026 Carlos Abalde <carlos.abalde@gmail.com> - 24.0-1.20260918
...
* Fri Aug 14 2026 Carlos Abalde <carlos.abalde@gmail.com> - 23.2-1.20260814
...
* Tue Mar 31 2026 Carlos Abalde <carlos.abalde@gmail.com> - 23.1-1.20260331
- Fixed several ARM64 portability issues.
* Tue Mar 17 2026 Carlos Abalde <carlos.abalde@gmail.com> - 23.0-1.20260317
...
- Fixed format string mismatch in unsafe_discover_redis_server_role.
- Fixed format string mismatch in Sentinel slaves error log.
- Fixed != vs == logic bug in vmod_db_get_array_reply_length.
- Fixed reply object leaks in Sentinel AUTH and HELLO commands.
* Mon Sep 15 2025 Carlos Abalde <carlos.abalde@gmail.com> - 22.0-1.20250915
- Migrated to Varnish Cache 8.0.x.
* Tue Mar 18 2025 Carlos Abalde <carlos.abalde@gmail.com> - 21.0-1.20250318
- Migrated to Varnish Cache 7.7.x.
* Fri Sep 13 2024 Carlos Abalde <carlos.abalde@gmail.com> - 20.0-1.20240913
- Migrated to Varnish Cache 7.6.x.
* Tue Mar 19 2024 Carlos Abalde <carlos.abalde@gmail.com> - 19.0-1.20240319
- Migrated to Varnish Cache 7.5.x.
* Fri Sep 15 2023 Carlos Abalde <carlos.abalde@gmail.com> - 18.0-1.20230915
...
* Thu Jun 02 2022 Carlos Abalde <carlos.abalde@gmail.com> - 15.1-1.20220602
- Fixed missing string terminator in .stats() method.
* Tue Mar 15 2022 Carlos Abalde <carlos.abalde@gmail.com> - 15.0-1.20220315
- Migrated to Varnish Cache 7.1.x.
* Wed Jan 12 2022 Carlos Abalde <carlos.abalde@gmail.com> - 14.1-1.20220112
- Added support for streaming & Prometheus format to the .stats() method.
- Added CHECK_OBJ_NOTNULL() checks in all free_*() functions.
* Wed Sep 15 2021 Carlos Abalde <carlos.abalde@gmail.com> - 14.0-1.20210915
- Migrated to Varnish Cache 7.0.x.
* Mon Mar 15 2021 Carlos Abalde <carlos.abalde@gmail.com> - 13.0-1.20210315
- Migrated to Varnish Cache 7.0.x.
* Tue Sep 15 2020 Carlos Abalde <carlos.abalde@gmail.com> - 12.0-1.20200915
- Migrated to Varnish Cache 6.5.x.
* Fri Jul 17 2020 Carlos Abalde <carlos.abalde@gmail.com> - 11.1-1.20200717
...
* Fri Mar 20 2020 Carlos Abalde <carlos.abalde@gmail.com> - 11.0-1.20200320
- Migrated to Varnish Cache 6.4.x.
* Fri Feb 21 2020 Carlos Abalde <carlos.abalde@gmail.com> - 10.1-1.20200221
- Added support for Redis Sentinel authentication.
- Added Linux Alpine fixes.
* Mon Sep 30 2019 Carlos Abalde <carlos.abalde@gmail.com> - 10.0-1.20190930
...
* Tue Aug 07 2018 Carlos Abalde <carlos.abalde@gmail.com> - 7.2-1.20180807
- Allowed disabling sickness TTL feature.
- Stopped WS-copying input arg in .command() & .push().
* Thu May 03 2018 Carlos Abalde <carlos.abalde@gmail.com> - 7.1-1.20180503
- Fixed execution plan when clustering enabled.
* Thu Mar 15 2018 Carlos Abalde <carlos.abalde@gmail.com> - 7.0-1.20180315
