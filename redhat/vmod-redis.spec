...
Requires: varnish >= 5.2.0, hiredis >= 0.11.0, libev >= 4.03
BuildRequires: make, python-docutils, varnish >= 5.2.0, varnish-devel >= 5.2.0, hiredis-devel >= 0.11.0, libev-devel >= 4.03
...
%changelog
* Thu May 23 2019 Carlos Abalde <carlos.abalde@gmail.com> - 6.3-1.20190523
