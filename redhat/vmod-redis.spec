...
BuildRequires: make, python-docutils, varnish >= 5.0.0, varnish-devel >= 5.0.0, hiredis-devel >= 0.11.0, libev-devel >= 4.03
...
%changelog
* Thu May 23 2019 Carlos Abalde <carlos.abalde@gmail.com> - 4.5-1.20190523
- Stopped depending on redis-trib.rb.
- Added REPLICAOF command (i.e. new SLAVEOF name) support.
* Tue Aug 07 2018 Carlos Abalde <carlos.abalde@gmail.com> - 4.4-1.20180807
- Allowed disabling sickness TTL feature.
- Stopped WS-copying input arg in .command() & .push().
* Tue Jul 14 2018 Carlos Abalde <carlos.abalde@gmail.com> - 4.3-1.20180714
- Merged missing commit: support for CLUSTER NODES output in 4.x in tests.
* Thu May 03 2018 Carlos Abalde <carlos.abalde@gmail.com> - 4.2-1.20180503
- Fixed execution plan when clustering enabled.
* Thu Jun 01 2017 Carlos Abalde <carlos.abalde@gmail.com> - 4.1-1.20170601
