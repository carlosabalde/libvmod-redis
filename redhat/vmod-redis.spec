...
Requires: varnish >= 6.2.0, hiredis >= 0.11.0, libev >= 4.03
BuildRequires: make, python-docutils, varnish >= 6.2.0, varnish-devel >= 6.2.0, hiredis-devel >= 0.11.0, libev-devel >= 4.03
